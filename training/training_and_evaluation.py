...
def evaluate_model_CNN(model, test_dataloader, device):
    '''
    Evaluates the CNN model on provided test data (test_dataloader).
    Prints AUC of Precision/Recall Curve, average value for precision
    and AUC of ROC
...
def train_model_CNN(model, epoch_num, opt, dataloader, val_dataloader, loss_fn,  device, file_path, writer, my_collate):
    '''
